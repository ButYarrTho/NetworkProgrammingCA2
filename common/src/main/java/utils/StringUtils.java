...
public class StringUtils {
    /**
     * Checks whether string is an email address.
     *
     * @param check The string to be checked.
     * @return True iff string is an email. False otherwise.
     */
    public static boolean isEmail(@NonNull String check) {
        // Email pattern from https://stackoverflow.com/a/201378
        ...
        Matcher matcher = emailPattern.matcher(check);
        return matcher.find();
    }
}
